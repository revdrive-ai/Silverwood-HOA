      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 py-10 grid gap-8 sm:grid-cols-3 text-sm">
        ...
        <div>
          ...
          <ul className="space-y-1">
            {site.nav.map((item) => (
              <li key={item.href}>
                <Link href={item.href} className="text-cream/80 hover:text-accent">
                  {item.label}
                </Link>
              </li>
            ))}
            <li>
              <a href={site.externalLinks.memberPortal} target="_blank" rel="noreferrer" className="text-cream/80 hover:text-accent">
                Member Portal
              </a>
            </li>
            <li>
              <a href={site.externalLinks.facebookGroup} target="_blank" rel="noreferrer" className="text-cream/80 hover:text-accent">
                Facebook Group
              </a>
            </li>
          </ul>
